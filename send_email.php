...
try {
    ...
    $mail->Username = 'benyouneshamza7@gmail.com';  // SMTP username
    $mail->Password = 'dhhahcupjrshaxpi';     // SMTP password (app password or your Gmail password)
    $mail->SMTPSecure = 'tls';                      // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                             // TCP port to connect to

    // Recipients
    $mail->setFrom($email, $name);
    $mail->addAddress('benyouneshamza7@gmail.com'); // Add a recipient
